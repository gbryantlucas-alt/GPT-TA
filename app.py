...
class MainWindow(QMainWindow):
    ...
    def _build_menu(self):
        ...
        save_action = menu.addAction("Save Settings")
...
QTextEdit, QLineEdit, QListWidget, QComboBox, QDoubleSpinBox, QTableWidget { background:white; border:1px solid #d1d5db; border-radius:6px; padding:6px; }
